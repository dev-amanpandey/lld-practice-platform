...
1. **Deterministic evaluation** for objective checks such as completeness and coverage of important problem concepts.
2. **AI-style rubric evaluation** for subjective design reasoning such as responsibilities, abstractions, extensibility and trade-offs.
